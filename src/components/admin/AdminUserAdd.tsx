            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                <Label htmlFor="firstName">
                  {t("inscription.first_name") || "First Name"}
                </Label>
                <Input
                  id="firstName"
                  placeholder="John"
              ...
              <div className="space-y-2">
                <Label htmlFor="lastName">
                  {t("inscription.last_name") || "Last Name"}
                </Label>
                <Input
                  id="lastName"
                  placeholder="Doe"
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="beginner">
                      {t("inscription.level.beginner")}
                    </SelectItem>
                    <SelectItem value="intermediate">
                      {t("inscription.level.intermediate")}
                    </SelectItem>
                    <SelectItem value="advanced">
                      {t("inscription.level.advanced")}
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
