      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={quizData.difficulty} onValueChange={(value: any) => setQuizData({ ...quizData, difficulty: value })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select value={quizData.languageId} onValueChange={(value) => setQuizData({ ...quizData, languageId: value })}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                    ...
                    <div key={index} className="flex justify-between items-start p-4 border rounded-lg">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <Badge variant="secondary">{question.type === 'mcq' ? 'اختيار متعدد' : question.type === 'fill' ? 'ملء فراغ' : 'صوتي'}</Badge>
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button onClick={handleSave} disabled={!quizData.title || questions.length === 0}>
